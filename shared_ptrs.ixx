...
%ref_counted_handle(VkSamplerYcbcrConversionKHR)
...
%raii_struct(VkBindBufferMemoryDeviceGroupInfoKHX)
...
%raii_struct(VkRenderPassInputAttachmentAspectCreateInfoKHR)
...
%raii_struct(VkBindImageMemoryDeviceGroupInfoKHX)
...
%apply (float* IN_ARRAY1, int DIM1) {(float* pCoverageModulationTable_in_array1, int pCoverageModulationTable_dim1)};
